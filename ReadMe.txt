...
GAMEPLAN: Need to come up with another project that uses all these principles, and I need to build it from scratch without having a specific guide for it. Furthermore there are a bunch of topics that I need to explore deeper to make sure that I have a good grasp on them such as: cubic beziers (I need to know exactly how they work, what all the options are, etc), flexbox (I need to do a bunch of projects that are flexbox heavy, until I get a really good grasp of it.), toggle functions, and specifically, I need to know the ins and outs of the .toggle feature (I need to make sure I know how to build them, and then I need to do a bunch of projects that require lots of toggle, so that I become really efficient with them), adding classes on top of classes. Dynamically adding classes (I need to make sure that I know exactly when and why it works, and when and why it doesn't work), js events and specifically how to remove events. Master forEach(I need to use it in different scenarios, and know when and why it works.). The this feature (I need to know how to use this and exactly how it works, once and for all. I also need to know all the differences between es6 and es5 when it comes to this keyword)
